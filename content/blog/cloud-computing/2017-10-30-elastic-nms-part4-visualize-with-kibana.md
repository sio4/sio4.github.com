...
![](/attachments/elastic-nms/elk-401-saved-search.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-402-visualize-from-search.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-403-tile-map.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-404-search-denied.jpg)
{.bordered}

위의 검색 결과를 보면, 필드 전체에 대하여 일치하는 레코드를 찾았다는 것을
느낄 수... 있다. (느끼는 것은 아닌데 좀...)

![](/attachments/elastic-nms/elk-405-table-and-save.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-406-area-chart.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-407-vertical-bar.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-408-donut.jpg)
{.bordered}
...
![](/attachments/elastic-nms/elk-411-dash-firewall.jpg)
{.bordered}
