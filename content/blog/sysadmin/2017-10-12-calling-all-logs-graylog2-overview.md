...
![](/attachments/graylog2/graylog-102-input-syslog.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-103-input-syslog.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-111-search-preset.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-122-search-preset.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-530-inputs-extractors.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-531-inputs-extractor-regex.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-532-inputs-extractor-grok.png)
{.dropshadow}

그런데 Graylog가 편하다는 부분은 바로 아래의 부분이다.

![](/attachments/graylog2/graylog-533-inputs-extractor-test.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-242-dashboard-inaction.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-245-dashboard-map.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-200-stream.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-202-stream-rules.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-210-stream-rule-edit.png)
{.dropshadow}

앞서 살펴본 Extractor와 동일하게, 여기서도 이미 존재하는 로그를 가져다
예제로 삼아 규칙을 지정할 수 있게 되어있다.

![](/attachments/graylog2/graylog-211-stream-rule-edit.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-220-stream-output.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-231-stream-alert-cond.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-232-stream-alert-cond.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-233-stream-alert-cond.png)
{.dropshadow}
...
![](/attachments/graylog2/graylog-234-stream-alert-callback.png)
{.dropshadow}

그리고 화면의 맨 아래에는, 이 설정을 통하여 이미 발송된 기록을 조회할 수
있다.

![](/attachments/graylog2/graylog-235-stream-alert-alerts.png)
{.dropshadow}
