...
참고로, "[Raft Concensus Algorithm]"에서 이 알고리즘에 대한 재미있는
설명을 볼 수 있다.
...
조금은 작의적인 구분이긴 하지만, 위의 구분이 크게 이상하지는 않다. 아무튼,
...
그렇다. Raft Concensus Algorithm에 의한 정족수의 Vote에 실패한 것이다.
...
이제, 새로 만은 Host를 Swarm에 등록할건데, 아예 처음부터 Worker가 아닌
Manager로 채용하려고 한다.
...
[Raft Concensus Algorithm]:http://thesecretlivesofdata.com/raft/
