...
tags: 리눅스 Bridge 네트워크 문제해결
date: 2015-08-21 12:46:40+09:00
---
...
1. 대상이 그 안을 건드릴 수 없는 Appliance이거나
...
원래의 모습은 아마도, 위의 그림에서 "목표시스템 A"의 NIC0가 직접
Switch0의 Port에 연결되어있었을 것이다. 그 선로 사이를 지나가는
